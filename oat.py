        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpgrup)
            elif msg.text.lower() == 'ออโต้.':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,helpset)
                else:
                    cl.sendText(msg.to,helpset)
            elif msg.text.lower() == 'แปลภาษา':
                if wait["lang"] == "JP":
            ...
            #    cl.sendText(msg.to, "%sseconds" % (elapsed_time))
                    ...
                    cl.sendText(msg.to,"「♥นี้ความเร่วของคุน♥」")
                    start = time.time()
                    for i in range(3000):
                        1+1
...
#========================== FOR COMMAND BOT STARTING =============================#
            elif msg.text.lower() == 'คอนแทค เปิด':
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"คอนแทค เปิดทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"คอนแทค เปิดทำงานแล้ว")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"คอนแทค เปิดทำงานแล้ว")
            elif msg.text.lower() == 'คอนแทค ปิด':
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"คอนแทค ปิดทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"คอนแทค ปิดทำงานแล้ว")
                else:
                    wait["contact"] = False
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ป้องกันห้อง ทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"ป้องกันห้อง ทำงานแล้ว")
                else:
                    wait["ป้องกัน"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ป้องกันห้อง ทำงานแล้ว")
            elif msg.text.lower() == 'ล็อกคิว เปิด':
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง เปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง เปิดการทำงานแล้ว")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง เปิดการทำงานแล้ว")
            elif msg.text.lower() == 'ล็อกเชิญ เปิด':
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ห้ามเชิญคน เปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"ห้ามเชิยคน เปิดการทำงานแล้ว")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ห้ามเชิยคน เปิดการทำงานแล้ว")
            elif msg.text.lower() == 'ยกเชิญ เปิด':
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ยกเชิญคน เปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ยกเชิญคน เปิดการทำงาน")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ยกเชิญคน เปิดการทำงาน")
            elif msg.text.lower() == 'ออโต้เข้ากลุ่ม เปิด':
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ เปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ เปิดการทำงาน")
                else:
                    wait["autoJoin"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ เปิดการทำงาน")
            elif msg.text.lower() == 'ออโต้เข้ากลุ่ม ปิด':
                if wait["autoJoin"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ ปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ ปิดการทำงาน")
                else:
                    wait["autoJoin"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"เข้ากลุ่มออโต้ ปิดการทำงาน")
            elif msg.text.lower() == 'ป้องกัน ปิด':
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ปิดการป้องกันห้องแล้ว")
                    else:
                        cl.sendText(msg.to,"ปิดการป้องกันห้องแล้ว")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ปิดการป้องกันห้องแล้ว")
            elif msg.text.lower() == 'ล็อกคิว ปิด':
                if wait["linkprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง ปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง ปิดการทำงานแล้ว")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ห้ามเปิดลิ่ง ปิดการทำงานแล้ว")
            elif msg.text.lower() == 'ล็อกเชิญ ปิด':
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ห้ามเชิญคน ปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"ห้ามเชิญคน ปิดการทำงานแล้ว")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ห้ามเชิญคน ปิดการทำงานแล้ว")
            elif msg.text.lower() == 'ยกเชิญ ปิด':
                if wait["cancelprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ยกเชิญคน ปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ยกเชิญคน ปิดการทำงาน")
                else:
            ...
            elif msg.text.lower() == 'ออกแชทรวม เปิด':
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม เปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม เปิดการทำงาน")
                else:
                    wait["leaveRoom"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม เปิดการทำงาน")
            elif msg.text.lower() == 'ออกแชทรวม ปิด':
                if wait["leaveRoom"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม ปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม ปิดการทำงาน")
                else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ออโต้ออกแชทรวม ปิดการทำงาน")
            elif msg.text.lower() == 'แชร์ เปิด':
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ออโต้แชร์ เปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ออโต้แชร์ เปิดการทำงาน")
                else:
                    wait["timeline"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ออโต้แชร์ เปิดการทำงาน")
            elif msg.text.lower() == 'แชร์':
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ออโต้แชร์ ปิดการทำงาน")
                    else:
                        cl.sendText(msg.to,"ออโต้แชร์ ปิดการทำงาน")
                else:
                    wait["timeline"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"ออโต้แชร์ ปิดการทำงาน")
            elif msg.text.lower() == 'เชค.':
                md = ""
                if wait["contact"] == True: md+="คอนแทค:เปิด 􀜁􀄯􏿿\n"
                else: md+="คอนแทค:ปิด􀜁􀄰􏿿\n"
                if wait["autoJoin"] == True: md+="ออโต้เข้ากลุ่ม:เปิด 􀜁􀄯􏿿\n"
                else: md +="ออโต้เข้ากลุ่ม:ปิด􀜁􀄰􏿿\n"
                if wait["autoCancel"]["on"] == True:md+="ยกเชิญกลุ่ม:" + str(wait["autoCancel"]["members"]) + "􀜁􀄯􏿿\n"
                else: md+= "ยกเชินกลุ่ม:ปิด 􀜁􀄰􏿿\n"
                if wait["leaveRoom"] == True: md+="ออกแชทรวม:เปิด 􀜁􀄯􏿿\n"
                else: md+="ออกแชทรวม:ปิด 􀜁􀄰􏿿\n"
                if wait["timeline"] == True: md+="แชร์:เปิด 􀜁􀄯􏿿\n"
                else:md+="แชร์:ปิด 􀜁􀄰􏿿\n"
                if wait["autoAdd"] == True: md+="ออโต้แอด:เปิด 􀜁􀄯􏿿\n"
                else:md+="ออโต้แอด:ปิด 􀜁􀄰􏿿\n"
                if wait["protect"] == True: md+="ป้องกันห้อง:เปิด 􀜁􀄯􏿿\n"
                else:md+="ป้องกันห้อง:ปิด 􀜁􀄰􏿿\n"
                if wait["linkprotect"] == True: md+="ห้ามเปิดลิ่ง:เปิด 􀜁􀄯􏿿\n"
                else:md+="ห้ามเปิดลิ่ง:ปิด 􀜁􀄰􏿿\n"
                if wait["inviteprotect"] == True: md+="ห้ามเชิญคน:เปิด 􀜁􀄯􏿿\n"
                else:md+="ห้ามเชิญคน:ปิด 􀜁􀄰􏿿\n"
                if wait["cancelprotect"] == True: md+="ยกเชิญ:เปิด 􀜁􀄯􏿿\n"
                else:md+="ยกเชิญ:ปิด 􀜁􀄰􏿿\n"
                ...
                cl.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text.lower() == 'ออโต้แอด เปิด':
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"รับแอดออโต้ เปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"รับแอดออโต้ เปิดการทำงานแล้ว")
                else:
                    wait["autoAdd"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"รับแอดออโต้ เปิดการทำงานแล้ว")
            elif msg.text.lower() == 'ออโต้แอด ปิด':
                if wait["autoAdd"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"รับแอดออโต้ ปิดการทำงานแล้ว")
                    else:
                        cl.sendText(msg.to,"รับแอดออโต้ ปิดการทำงานแล้ว")
                else:
                    wait["autoAdd"] = False
...
#==============================================#
        ...
        if op.type == 17:
          ...
          random.choice(KAC).sendText(op.param1, "😎มาใหม่แก้ผ้า แนะนำตัวด้วย")
          print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "ออกแล้วหรอเสียใจจุง😂")
